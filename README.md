...
** procfile is needed to deploy app.py file to heroku (web: gunicorn app:app)
*** BUT, here we are deploying app with main.py using httpd.serve_forever(); SO you can ignore the below code
```
...
DOCKER_IMAGE_NAME=wafercircleci0247
```
